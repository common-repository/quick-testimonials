      ...
      if( ! empty( $this->sections ) ) {
        ...
        foreach( $sections as $section ) {
          ...
          if( ! empty( $section['subs'] ) ) {
            ...
            $panel_id = $this->unique .'-panel-'. $this->priority;
            ...
            foreach( $section['subs'] as $sub_section ) {
              $this->add_section( $wp_customize, $this->unique .'-section-'. $this->priority, $sub_section, $panel_id );
              $this->priority++;
            }

          } else {
            $this->add_section( $wp_customize, $this->unique .'-section-'. $this->priority, $section, false );
            $this->priority++;
          }
