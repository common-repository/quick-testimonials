...
if( ! class_exists( 'CSF_Shortcoder' ) ) {
  class CSF_Shortcoder extends CSF_Abstract{
    ...
    ?>
      <div id="csf-modal-<?php echo $this->unique; ?>" class="csf-modal csf-shortcode<?php echo $single_usage; ?>" data-modal-id="<?php echo $this->unique; ?>" data-nonce="<?php echo wp_create_nonce( 'csf_shortcode_nonce' ); ?>">
        <div class="csf-modal-table">
          <div class="csf-modal-table-cell">
            ...
            <div class="csf-modal-inner">
              ...
              <div class="csf-modal-insert-wrapper wp-core-ui hidden"><a href="#" class="button button-primary csf-modal-insert"><?php echo $this->args['insert_title']; ?></a></div>
            </div>
          </div>
        </div>
      </div>
      ...
      if( ! empty( $shortcode_key ) && wp_verify_nonce( csf_get_var( 'nonce' ), 'csf_shortcode_nonce' ) ) {
        ...
        if( ! empty( $section ) ) {
          ...
          if( ! empty( $repeatable_fields ) ) {
            ...
            echo '<div class="csf--repeat-button-block wp-core-ui"><a class="button csf--repeat-button" href="#"><i class="fa fa-plus-circle"></i> '. $button_title .'</a></div>';
